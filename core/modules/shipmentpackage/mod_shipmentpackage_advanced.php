...
class mod_shipmentpackage_advanced extends ModeleNumRefShipmentPackage
{
	...
	public function info()
	{
		...
		$texte .= '<input type="hidden" name="maskconstShipmentPackage" value="SHIPMENTPACKAGE_SHIPMENTPACKAGE_ADVANCED_MASK">';
		...
		$texte .= '<td class="right">'.$form->textwithpicto('<input type="text" class="flat minwidth175" name="maskShipmentPackage" value="'.getDolGlobalString('SHIPMENTPACKAGE_SHIPMENTPACKAGE_ADVANCED_MASK') .'">', $tooltip, 1, 1).'</td>';
	...
	public function getNextValue($object)
	{
		...
		// We get cursor rule
		$mask = getDolGlobalString('SHIPMENTPACKAGE_SHIPMENTPACKAGE_ADVANCED_MASK');
