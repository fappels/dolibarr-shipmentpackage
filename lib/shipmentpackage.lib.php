...
function shipmentpackageAdminPrepareHead()
{
	...
	$head[$h][0] = dol_buildpath("/shipmentpackage/admin/setup.php", 1);
	$head[$h][1] = $langs->trans("Settings");
	$head[$h][2] = 'settings';
	$h++;

	$head[$h][0] = dol_buildpath("/shipmentpackage/admin/shipmentpackage_extrafields.php", 1);
	$head[$h][1] = $langs->trans("ExtraFields");
	$head[$h][2] = 'extrafields';
	$h++;

	$head[$h][0] = dol_buildpath("/shipmentpackage/admin/about.php", 1);
	...
	//	'entity:-tabname:Title:@shipmentpackage:/shipmentpackage/mypage.php?id=__ID__'
	//); // to remove a tab
	complete_head_from_modules($conf, $langs, null, $head, $h, 'shipmentpackage');
